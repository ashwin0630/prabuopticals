    ...
    <div className='bg-gray-950 text-white  pb-3 md:h-screen '>
      ...
      <div className='flex flex-col   md:flex-row m-5 justify-center items-center'>
        <div className='h-[500px] p-3 w-full  md:w-[450px] mb-5 md:mb-0 bg-white/10 backdrop-blur-xl rounded-xl md:mr-10'>
          ...
          <p className='text-white text-md mb-10 pt-5 font-bold mr-15 text-left'><GiRoundStar size={30} className='inline mr-2 pb-1' />Product1</p>
          <p className='text-white text-md mb-10 font-bold mr-15 text-left'><GiRoundStar size={30} className='inline mr-2 pb-1' />Product1</p>
          <p className='text-white text-md mb-10 font-bold mr-15 text-left'><GiRoundStar size={30} className='inline mr-2 pb-1' />Product1</p>
          <p className='text-white text-md mb-10 font-bold mr-15 text-left'><GiRoundStar size={30} className='inline mr-2 pb-1' />Product1</p>
          <p className='text-white text-md mb-10 font-bold mr-15 text-left'><GiRoundStar size={30} className='inline mr-2 pb-1' />Product1</p>
